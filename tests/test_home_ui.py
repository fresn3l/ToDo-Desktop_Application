...
class HomeUiTests(unittest.TestCase):
    ...
    def test_old_pages_are_widget_sources(self) -> None:
        ...
        self.assertIn("Happened", INDEX)
        self.assertIn("Missed", INDEX)
        self.assertNotIn("Did not complete", INDEX)
    ...
    def test_calendar_month_year_markup(self) -> None:
        ...
        self.assertIn("This week", CAL_JS)
        self.assertNotIn("Due soon", CAL_JS)
        ...
        self.assertIn("Drag from Today or To Do onto the clock", CAL_JS)
    ...
    def test_calendar_ics_paste_inserts_url_instead_of_navigating(self) -> None:
        ...
        self.assertIn("askRepeatScope", CAL_JS)
        self.assertIn("workScopeRemember", INDEX)
        self.assertIn("cal-work-group", CAL_JS)
        self.assertIn("parkWorkFromToday", CAL_JS)
        ...
        self.assertIn(">To Do</h3>", INDEX)
        self.assertIn("<h2>Today</h2>", INDEX)
        self.assertIn("Alt marks happened", INDEX)
        ...
        self.assertIn("Open in Today", INDEX)
    ...
    def test_cluny_ask_widget_and_day_hook(self) -> None:
        ...
        self.assertIn("Added to To Do. You pick the day.", cluny)
        ...
        self.assertIn("Fill week packs To Do, not Today", INDEX)
        self.assertNotIn("All Work", INDEX)
        self.assertIn(">To Do</button>", INDEX)
        work_js = (ROOT / "web" / "js" / "work.js").read_text(encoding="utf-8")
        self.assertIn("From To Do", work_js)
        self.assertIn("To Do is empty", work_js)
