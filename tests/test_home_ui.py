...
class HomeUiTests(unittest.TestCase):
    ...
    def test_calendar_ics_paste_inserts_url_instead_of_navigating(self) -> None:
        ...
        self.assertIn("NSResponder.paste", SWIFT)
        self.assertIn("NSResponder.copy", SWIFT)
        self.assertIn("NSResponder.cut", SWIFT)
        self.assertIn("NSResponder.selectAll", SWIFT)
        ...
        self.assertIn("min-height: 1.5rem", STYLE)
